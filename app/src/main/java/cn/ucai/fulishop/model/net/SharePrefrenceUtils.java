...
public class SharePrefrenceUtils {
    private static final String SHARE_PREFRENCE_NAME = "cn.ucai.fulishop_user";
    private static final String SHARE_PREFRENCE_NAME_USERNAME = "cn.user.fulishop_user_username";
